...
try:
    dbcur.execute(
        'CREATE TABLE (url VARCHAR(255) UNIQUE, html TEXT, title VARCHAR(255), text TEXT, date DATETIME, authors VARCHAR(255), channels VARCHAR(255));')
    dbcon.commit()
except:
...
### With more precision, we should consider a time difference. But I can't find the timezone of TECHCRUNCH.
